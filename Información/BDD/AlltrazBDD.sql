...
--
-- Servidor: mysql
-- Tiempo de generación: 23-05-2023 a las 06:37:33
...
--
ALTER TABLE `Buscar`
  ADD CONSTRAINT `Buscar_ibfk_2` FOREIGN KEY (`id_Usuario`) REFERENCES `Usuario` (`Id_usuario`),
  ADD CONSTRAINT `Buscar_ibfk_1` FOREIGN KEY (`id_Producto`) REFERENCES `Producto` (`Id_producto`);
